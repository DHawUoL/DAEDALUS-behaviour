...
tvec=[1    32    61    91   107   169   176   223   227   230   250   258   265   271   279   294   310   322   330   338   349   370   384    407   418   433   445   463   474   491   504   517   540   561   567   575   594   605   617   631   642   652   661   679   693   702    716   742   784];
lt=length(tvec);
tvec=tvec(1:(lt-15));
tdiff=diff(tvec);
